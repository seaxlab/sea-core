 ...
 * JSON字符串与实体对象互相转换
 * <p>
 * 用法一: 入库：#{jsonDataField, typeHandler=com.xxx.JSONTypeHandler} 出库：
 * <resultMap>
 * <result property="jsonDataField" column="json_data_field" javaType="com.xxx.MyClass"
 * typeHandler="com.xxx.JSONTypeHandler"/>
 * </resultMap>
 * </p>
 * <p>
