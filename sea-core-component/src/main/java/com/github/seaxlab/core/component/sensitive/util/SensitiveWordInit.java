package com.github.seaxlab.core.component.sensitive.util;
...
public class SensitiveWordInit {
  ...
  /**
   * 读取敏感词库，将敏感词放入HashSet中，构建一个DFA算法模型：<br> 中 = { isEnd = 0 国 = {<br> isEnd = 1 人 = {isEnd = 0 民 = {isEnd = 1} } 男  = {
   * isEnd = 0 人 = { isEnd = 1 } } } } 五 = { isEnd = 0 星 = { isEnd = 0 红 = { isEnd = 0 旗 = { isEnd = 1 } } } }
   */
