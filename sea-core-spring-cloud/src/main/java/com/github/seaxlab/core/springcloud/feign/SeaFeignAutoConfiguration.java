...
import com.github.seaxlab.core.springcloud.feign.config.MockFeignConfig;
import feign.Feign;
...
@ConditionalOnProperty(prefix = "sea.spring.cloud.feign", name = "enabled", havingValue = "true")
@EnableConfigurationProperties({FeignMockProperties.class})
@Import(MockFeignConfig.class)
