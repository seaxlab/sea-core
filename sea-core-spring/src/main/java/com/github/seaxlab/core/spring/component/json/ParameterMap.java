...
/**
 * fork from  tomcat-embed-core org.apache.catalina.util.ParameterMap
 * <p>
 ...
 * @since 1.0
 */
public class ParameterMap<K, V> implements Map<K, V>, Serializable {
    ...
    private void checkLocked() {
        if (locked) {
            throw new IllegalStateException("custom parameterMap.locked");
        }
    }
