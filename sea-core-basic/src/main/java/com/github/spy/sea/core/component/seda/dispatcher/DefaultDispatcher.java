package com.github.spy.sea.core.component.seda.dispatcher;

import com.github.spy.sea.core.component.seda.*;
...
import com.github.spy.sea.core.component.seda.exception.InvalidStageException;
...
public class DefaultDispatcher implements Dispatcher {
    ...
    public boolean execute(String stageId, Message message) throws InvalidStageException {
        return this.execute(new Event(stageId, message));
    }
