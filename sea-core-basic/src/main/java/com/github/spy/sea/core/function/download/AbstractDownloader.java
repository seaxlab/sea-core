package com.github.spy.sea.core.function.download;

import com.github.spy.sea.core.exception.ExceptionHandler;
import com.github.spy.sea.core.function.download.model.DownloaderDTO;
import com.github.spy.sea.core.function.download.model.DownloaderVO;
...
public abstract class AbstractDownloader<A extends DownloaderDTO> implements Downloader {
    ...
    protected long getRemoteFileContentLength(DownloaderDTO dto) throws Exception {
        ...
        long contentLength = StringUtil.isEmpty(header.getValue()) ? 0 : Long.valueOf(header.getValue());
