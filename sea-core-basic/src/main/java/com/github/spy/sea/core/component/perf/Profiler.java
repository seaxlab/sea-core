...
public final class Profiler {
    ...
    /**
     * entry中含有sub entry，如此这样来进行循环来保持树状的结构
     */
    ...
    public static final class Entry {
        ...
        private Entry(Object message/*描述信息*/, Entry parentEntry/*父节点信息*/, Entry firstEntry/*第一个节点*/) {
            ...
            this.startTime = ProfilerConfig.getInstance().isOpenProfilerNanoTime() ?
                    System.nanoTime() :
        ...
        private void release() {
            endTime = ProfilerConfig.getInstance().isOpenProfilerNanoTime() ?
                    System.nanoTime() :
                    System.currentTimeMillis();
        }
        ...
        private void toString(StringBuffer buffer, String prefix1, String prefix2) {
            ...
            double percentOfAll = getPercentOfAll();
            ...
            if (isReleased()) {
                ...
                if (ProfilerConfig.getInstance().isOpenProfilerNanoTime()) {
                    pattern.append("ns");
                } else {
                    pattern.append("ms");
                }
