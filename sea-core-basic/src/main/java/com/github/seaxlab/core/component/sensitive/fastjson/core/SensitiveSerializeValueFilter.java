package com.github.seaxlab.core.component.sensitive.fastjson.core;

import com.alibaba.fastjson.serializer.ValueFilter;
import com.github.seaxlab.core.component.sensitive.fastjson.annotation.SensitiveInfo;
  ...
  public Object process(Object object, String name, Object value) {
    ...
    try {
      ...
      if (sensitiveInfoAnno.begin() == 0 && sensitiveInfoAnno.end() == 0) {
        return strategy.desensitizationByPattern((String) value, sensitiveInfoAnno.pattern(),
          sensitiveInfoAnno.replaceChar());
      } else {
