...
public final class MoreLocks {
   ...
   */
  public static <X extends Throwable> void runWithTryLock(Lock lock, long time, TimeUnit unit,
    ThrowableRunnable<X> runnable, Runnable withoutAcquiredLock) throws X, InterruptedException {
   ...
   * @throws X 执行异常
   */
  public static <X extends Throwable> void runWithTryLock(Lock lock, ThrowableRunnable<X> runnable)
    throws X {
   ...
   */
  public static <X extends Throwable> void runWithTryLock(Lock lock, ThrowableRunnable<X> runnable,
    Runnable withoutAcquiredLock) throws X {
   ...
   */
  private static <X extends Throwable> ThrowableSupplier<Void, X> wrapAsRunnable(
