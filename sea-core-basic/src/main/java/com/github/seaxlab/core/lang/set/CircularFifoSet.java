...
import com.github.seaxlab.core.lang.collection.BoundedCollection;
 ...
 */
@Slf4j
public class CircularFifoSet<E> extends AbstractCollection<E> implements Set<E>, BoundedCollection<E> {
    ...
    public CircularFifoSet() {
        this(32);
    }

    public CircularFifoSet(final int size) {
        if (size <= 0) {
    ...
    public boolean add(final E element) {
        ...
        //check has exist
        boolean exist = Arrays.stream(elements).anyMatch(item -> item != null && element.hashCode() == item.hashCode());
        if (exist) {
            return true;
        }
