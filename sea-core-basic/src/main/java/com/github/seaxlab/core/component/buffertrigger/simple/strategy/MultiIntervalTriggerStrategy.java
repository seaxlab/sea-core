package com.github.seaxlab.core.component.buffertrigger.simple.strategy;
...
import com.github.seaxlab.core.component.buffertrigger.simple.SimpleBufferTriggerBuilder;
import com.github.seaxlab.core.component.buffertrigger.simple.TriggerResult;
import com.github.seaxlab.core.component.buffertrigger.simple.TriggerStrategy;
 ...
 * <p>
 * 注意，这里的触发条件和 Kafka Producer 的 linger 不一样，并不是 时间和次数达到一个就触发一次 而是指定时间内累计到特定次数才触发，所以一般会有一个兜底的 1
 * 次来做时间触发
 * <p>
 * 更进一步，我们的场景大多数时候一般使用 {@link SimpleBufferTriggerBuilder#interval} 触发就能满足业务的基本需求 所以目前
 * {@link SimpleBufferTrigger} 没有提供类 Kafka Producer 的 linger 触发模式；
 *
 * @author w.vela Created on 15/07/2016.
 */
public class MultiIntervalTriggerStrategy implements TriggerStrategy {
  ...
  public TriggerResult canTrigger(long lastConsumeTimestamp, long changedCount) {
    ...
    return TriggerResult.trig(doConsumer, minTriggerPeriod);
  }
}
