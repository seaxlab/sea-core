...
public class ConditionFactory {
   ...
   * @return
   */
  public static boolean match(final ConditionContext context, final MatchModeEnum matchModeEnum,
    final List<ConditionData> conditionDataList) {
    //
    return MatchStrategyFactory.newInstance(matchModeEnum.getCode())
      .match(context, conditionDataList);
  }
   ...
   * @return
   */
  public static boolean match(final ConditionContext context, final Integer strategy,
    final List<ConditionData> conditionDataList) {
    //
