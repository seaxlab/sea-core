...
public abstract class LazyInitializer<T> implements ConcurrentInitializer<T> {
   ...
   * @throws org.apache.commons.lang3.concurrent.ConcurrentException if an error occurred during initialization of
   *                                                                 the object
   */
  @Override
   ...
   * @throws org.apache.commons.lang3.concurrent.ConcurrentException if an error occurs during object creation
   */
