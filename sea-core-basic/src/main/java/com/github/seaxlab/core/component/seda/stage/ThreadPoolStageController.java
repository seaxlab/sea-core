...
import com.github.seaxlab.core.component.seda.TimeoutEnabled;
import com.github.seaxlab.core.component.seda.event.Event;
import com.github.seaxlab.core.component.seda.event.RunnableEventHandlerWrapper;
import com.github.seaxlab.core.component.seda.thread.DefaultThreadPoolExecutorFactory;
import com.github.seaxlab.core.component.seda.thread.ThreadPoolExecutorFactory;
...
public class ThreadPoolStageController implements StageController {
    ...
    public static final String THREAD_POOL_EXECUTOR_MXBEAN_PREFIX = "com.github.seaxlab.core.seda.thread:type=ThreadPoolExecutor,name=tpe-";
