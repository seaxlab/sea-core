...
public class GenericSimpleBufferTriggerBuilder<E, C> {
   ...
   * 一般函数调用位于处理请求线程池，该函数的耗时将直接影响业务服务并发效率， 推荐使用者实现更贴合实际业务的高性能线程安全容器.
   * <p>
   ...
   */
  @CheckReturnValue
  public GenericSimpleBufferTriggerBuilder<E, C> triggerStrategy(TriggerStrategy triggerStrategy) {
    builder.triggerStrategy(triggerStrategy);
    return this;
  }

  @CheckReturnValue
  public GenericSimpleBufferTriggerBuilder<E, C> intervalAtFixedRate(long interval, TimeUnit unit) {
    builder.triggerStrategy(new TriggerStrategy() {
      ...
      public TriggerResult canTrigger(long last, long change) {
        ...
        return TriggerResult.trig(change > 0, result);
      }
    });
    return this;
  }
  ...
  public GenericSimpleBufferTriggerBuilder<E, C> consumer(
    ThrowableConsumer<Integer, Throwable> consumer) {
  ...
  @CheckReturnValue
  public GenericSimpleBufferTriggerBuilder<E, C> enableBackPressure(
    BackPressureListener<E> listener) {
