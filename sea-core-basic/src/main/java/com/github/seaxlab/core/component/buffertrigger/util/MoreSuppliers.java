...
public final class MoreSuppliers {
   ...
   * @return 返回一个懒加载的提供器，与原提供器兼容
   */
  public static <T, X extends Throwable> CloseableThrowableSupplier<T, X> lazyEx(
   ...
   */
  public static <T, X extends Throwable> CloseableThrowableSupplier<T, X> lazyEx(
    ThrowableSupplier<T, X> delegate, boolean resetAfterClose) {
   ...
   * @param <X> 操作异常泛型
   */
  public static class CloseableThrowableSupplier<T, X extends Throwable> implements
