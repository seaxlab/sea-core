...
public class AllocateConsistentHash implements AllocateStrategy {
    ...
    @Override
    public List<com.github.seaxlab.core.component.allocate.Node> allocate(String consumerGroup, String currentCID, List<com.github.seaxlab.core.component.allocate.Node> nodeAll,
                                                                          List<String> cidAll) {
