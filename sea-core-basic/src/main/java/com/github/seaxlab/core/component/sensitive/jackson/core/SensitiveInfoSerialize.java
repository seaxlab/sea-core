package com.github.seaxlab.core.component.sensitive.jackson.core;
...
import com.github.seaxlab.core.component.sensitive.jackson.annotation.SensitiveInfo;
      ...
      if (Objects.equals(beanProperty.getType().getRawClass(), String.class)) {
        ...
        if (sensitiveInfo != null) {
          ...
          return new SensitiveInfoSerialize(clazz.getDeclaredConstructor().newInstance(),
            sensitiveInfo.pattern(), sensitiveInfo.replaceChar(), sensitiveInfo.begin(), sensitiveInfo.end());
        }
