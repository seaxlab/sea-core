...
public class FileWatchServiceThreadTest {
    @Rule
    ...
    public void watchSingleFile() throws Exception {
        ...
        FileWatchServiceThread fileWatchService = new FileWatchServiceThread(new String[]{file.getAbsolutePath()},
                path -> {
    ...
    public void watchSingleFile_FileDeleted() throws Exception {
        ...
        final Semaphore waitSemaphore = new Semaphore(0);
        FileWatchServiceThread fileWatchService = new FileWatchServiceThread(new String[]{file.getAbsolutePath()},
                new FileWatchServiceThread.Listener() {
                    @Override
    ...
    public void watchTwoFile_FileDeleted() throws Exception {
        ...
        final Semaphore waitSemaphore = new Semaphore(0);
        FileWatchServiceThread fileWatchService = new FileWatchServiceThread(
