package com.github.seaxlab.core.io.archiver;
 ...
 */
@Slf4j
public class ApacheCompressArchiverTest extends BaseCoreTest {

    @Test
    public void archiverTest() throws Exception {
        String sourceDir = getUserHome() + "/logs/sea";
        String destFile = getUserHome() + "/logs/sea.apache.zip";

        FileUtil.deleteFiles(destFile);

        File file = new File(sourceDir);
        compressFiles2Zip(file.listFiles(), destFile);
    ...
    public void unArchiverTest() throws Exception {
        ...
        String sourceFile = getUserHome() + "/logs/sea.apache.zip";
            ...
            if (isEndsWithZip(zipFilePath)) {
                ...
                try {
                    ...
                    for (File file : files) {
                        if (file != null) {
                            if (!file.isFile()) {
                                log.warn("[{}] is not file", file.getAbsolutePath());
                                continue;
                            }
