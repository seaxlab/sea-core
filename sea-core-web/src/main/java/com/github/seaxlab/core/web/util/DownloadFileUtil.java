...
public class DownloadFileUtil {
   ...
   * @throws Exception
   */
  public static String getFilenameStr(HttpServletRequest request, String realFileName) throws Exception {
    String browName;
    ...
    if (clientInfo != null && clientInfo.indexOf("MSIE") > 0) {//
      // IE采用URLEncoder方式处理
      if (clientInfo.indexOf("MSIE 6") > 0 || clientInfo.indexOf("MSIE 5") > 0) {// IE6，用GBK，此处实现有局限性
